...
fdat = load_regional_association_data(genotype = '/home/jovyan/AWS/data/protocal_data/protocol_example.protein.enhanced_cis_chr21_chr22_genotype_by_region/protocol_example.genotype.chr21_22.ENSG00000142192_P05067',
                                      ...
                                      region = "chr21:26171127-26171128",
                                      conditions = c('A','B'),
                                      maf_cutoff = 0,
                                      mac_cutoff = 10,
                                      imiss_cutoff = 1,
...
saveRDS(fitted, '/home/jovyan/AWS/data/susie_original2/susie/protocol_example_protein.ENSG00000142192_P05067.susie_fitted.rds')
