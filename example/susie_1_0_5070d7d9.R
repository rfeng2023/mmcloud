...
fdat = load_regional_association_data(genotype = '/home/jovyan/AWS/data/protocal_data/protocol_example.protein.enhanced_cis_chr21_chr22_genotype_by_region/protocol_example.genotype.chr21_22.ENSG00000154654_O15394',
                                      phenotype = c("/home/jovyan/AWS/data/protocal_data/phenotype/protocol_example.protein.bed.gz","/home/jovyan/AWS/data/protocal_data/phenotype/protocol_example.protein.bed.gz"),
                                      covariate = c("/home/jovyan/AWS/data/protocal_data/covariate/protocol_example.protein.protocol_example.samples.protocol_example.genotype.chr21_22.pQTL.plink_qc.prune.pca.Marchenko_PC.gz","/home/jovyan/AWS/data/protocal_data/covariate/protocol_example.protein.protocol_example.samples.protocol_example.genotype.chr21_22.pQTL.plink_qc.prune.pca.Marchenko_PC.gz"),
                                      region = "chr21:20998408-20998409",
                                      conditions = c('A','B'),
                                      maf_cutoff = 0,
                                      mac_cutoff = 10,
                                      imiss_cutoff = 1,
...
for (r in 1:length(fdat$residual_Y_scaled)) { ## Cant have a universal way to specify names due to the accomodation of missingness, use index instead
    ...
    fitted[[r]]$phenotype_name = names(fdat$residual_Y_scaled[[r]])
    fitted[[r]]$dropped_samples = fdat$dropped_sample[[r]]
    fitted[[r]]$sample_names = colnames(fdat$residual_Y_scaled[[r]])
}
saveRDS(fitted, '/home/jovyan/AWS/data/susie_original2/susie/protocol_example_protein.ENSG00000154654_O15394.susie_fitted.rds')
